...
void main() {
  group('FadeThroughPageRoute tests', () {
    ...
    group('buildTransitions functionality', () {
      testWidgets('buildTransitions creates FadeThroughTransition', (WidgetTester tester) async {
      ...
      testWidgets('buildTransitions uses both primary and secondary animations', (WidgetTester tester) async {
        const testWidget = Text('Test Child');
        final route = FadeThroughPageRoute(child: testWidget);
    ...
    group('edge cases and error handling', () {
      testWidgets('handles widgets with global keys', (WidgetTester tester) async {
                  ...
                  Builder(
                    builder: (context) {
                      return ElevatedButton(
                        onPressed: () {
                          Navigator.of(context).push(
                            FadeThroughPageRoute(child: _TestPage(text: 'Fade Through')),
                          );
                        },
